...
public class JanelaChat extends javax.swing.JFrame implements Runnable {
    ...
    private static Usuario usuarioTODOS = new Usuario("TODOS");
    ...
    public JanelaChat(String login, ConectarServidor conectar) throws IOException {
        ...
        jTextArea1.setText("#"+login.toUpperCase() + " ENTROU#");
        ...
        model.addElement(usuarioTODOS);//insere TODOS
    }

    private JanelaChat(JTextArea historicoMensagens, String ipGrupo) {
        System.out.println("Thread para receber multicast iniciada.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            enviarMensagemMulticast(login.toUpperCase() + " diz: " + mensagem + "|");
            jTextField1.setText("");
            jTextField1.requestFocus();
    ...
    public void mostrarConversas(String mensagem) {
        if (mensagem.startsWith("LISTA:")) {
            ...
            if (split.length >= tamanhoLista) {
                model.clear();
                model.addElement(usuarioTODOS);
                for (int i = 3; i < split.length; i++) {
                    usuario = new Usuario(split[i]);
                    model.addElement(usuario);
                }
                tamanhoLista = split.length;
                split = null;
            }
        } else {
